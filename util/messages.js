jQuery.sap.declare("test05.util.messages");
...
test05.util.messages.showErrorMessage = function(oParameter) {



	var oErrorDetails = test05.util.messages._parseError(oParameter);
...
test05.util.messages.getErrorContent = function(oParameter) {



	return test05.util.messages._parseError(oParameter).sMessage;
...
test05.util.messages._parseError = function(oParameter) {
